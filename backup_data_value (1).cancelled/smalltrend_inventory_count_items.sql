...
CREATE TABLE `inventory_count_items` (
  ...
  `difference_value` decimal(38,2) DEFAULT NULL,
  `product_id` int DEFAULT NULL,
  `reason` varchar(255) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `system_quantity` int DEFAULT NULL,
  `inventory_count_id` int DEFAULT NULL,
  `variant_id` int DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `FKomikfexjgcrwpety96p9lvoq3` (`inventory_count_id`),
  CONSTRAINT `FKomikfexjgcrwpety96p9lvoq3` FOREIGN KEY (`inventory_count_id`) REFERENCES `inventory_counts` (`id`)
