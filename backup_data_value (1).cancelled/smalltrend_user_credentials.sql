...
CREATE TABLE `user_credentials` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `UK_8pcilw7ay5rs8c4dtrtik21pw` (`username`),
  UNIQUE KEY `UK_thx1lw5kg5ygi8d8b90gv2ha3` (`user_id`),
  CONSTRAINT `FK98kxj78ausx1xo94eq4mkjm9q` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`)
