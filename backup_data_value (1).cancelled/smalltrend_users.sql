...
CREATE TABLE `users` (
  ...
  `count_late_as_present` bit(1) NOT NULL,
  `hourly_rate` decimal(8,2) DEFAULT NULL,
  `min_required_shifts` int DEFAULT NULL,
  `salary_type` enum('MONTHLY','MONTHLY_MIN_SHIFTS','HOURLY') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `working_hours_per_month` decimal(6,2) DEFAULT NULL,
  PRIMARY KEY (`id`),
