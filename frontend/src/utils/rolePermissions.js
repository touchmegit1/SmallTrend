...
export const PRODUCT_READONLY_ROLES = [...CASHIER_ROLES];

export const POS_ROLES = [...ADMIN_ROLES, ...MANAGER_ROLES, ...CASHIER_ROLES];
...
export const INVENTORY_FULL_ROLES = [...ADMIN_ROLES, ...MANAGER_ROLES, ...INVENTORY_ROLES];
...
export const CRM_ROLES = [...ADMIN_ROLES, ...MANAGER_ROLES];
