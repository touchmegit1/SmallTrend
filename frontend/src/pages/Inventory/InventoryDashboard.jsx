...
function InventoryDashboard() {
    ...
    const activities = [
        { id: 1, code: 'NK-001', type: 'Nhập', product: 'Áo thun nam', quantity: 50, time: '10:30 AM' },
        { id: 2, code: 'XK-045', type: 'Xuất', product: 'Quần jean nữ', quantity: 20, time: '09:15 AM' },
        { id: 3, code: 'NK-002', type: 'Nhập', product: 'Giày thể thao', quantity: 30, time: '08:45 AM' },
        { id: 4, code: 'XK-046', type: 'Xuất', product: 'Túi xách', quantity: 15, time: '08:00 AM' },
        { id: 5, code: 'NK-003', type: 'Nhập', product: 'Áo khoác', quantity: 40, time: '07:30 AM' },
    ];
    ...
    return (
        <div style={{ padding: '20px', backgroundColor: '#f5f5f5', minHeight: '100vh' }}>
            ...
            <div style={{ marginBottom: '20px' }}>
                <h1 style={{ fontSize: '24px', fontWeight: 'bold' }}>Tổng quan kho hàng</h1>
                <p style={{ fontSize: '14px', color: '#999' }}>Thứ Bảy, 31 tháng 1, 2026</p>
            </div>
