...
const STATUS_COLORS = {
  ...
  DRAFT: { bg: "#f1f5f9", color: "#475569", label: "Phiếu tạm" },
  CHECKING: { bg: "#f3e8ff", color: "#6b21a8", label: "Đang kiểm kê" },
  RECEIVED: { bg: "#dcfce7", color: "#166534", label: "Đã nhập kho" },
              ...
              return (
                <button
                  ...
                  style={{
                    ...
                    color:
                      value === option.value ? optionStyle.color : "#475569",
                    display: "block",
                    width: "100%",
                  }}
                  onMouseEnter={(e) => {
