      ...
      <div className="bg-blue-50 px-6 py-4 border-b border-slate-200">
        <div className="space-y-3 text-sm">
          <div className="flex justify-between items-center">
            <span className="text-slate-600">Mã phiếu nhập</span>
            <input
              type="text"
              value={importForm.po_number}
              disabled
              className="text-right font-semibold text-slate-900 bg-transparent border-none focus:outline-none w-32"
            />
          </div>
          <div className="flex justify-between items-center">
          ...
          <div className="flex justify-between items-center">
            ...
            <input
              type="number"
              defaultValue="0"
              className="text-right font-semibold text-slate-900 bg-transparent border-none focus:outline-none w-20"
            />
          </div>
          <div className="flex justify-between items-center">
