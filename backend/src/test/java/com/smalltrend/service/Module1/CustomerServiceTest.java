...
class CustomerServiceTest {
    ...
    void getCustomerById_shouldThrowException_whenIdInvalid() {
        ...
        CrmException exception = assertThrows(
                CrmException.class,
    ...
    void updateCustomer_shouldReturnUpdatedCustomer_whenValid() {
        ...
        CustomerResponse response =
                customerService.updateCustomer(1, "New Name", "0987654321", 200, 500000L);
    ...
    void updateCustomer_shouldThrowException_whenIdInvalid() {
        ...
        CrmException exception = assertThrows(
                CrmException.class,
                () -> customerService.updateCustomer(99, "Name", "0123456789", 100, 500000L)
        );
    ...
    void getCustomerByPhone_shouldReturnCustomer_whenPhoneExists() {
        ...
        when(customerRepository.findByPhoneIgnoreSpaces("0912345678"))
    ...
    void getCustomerByPhone_shouldThrowException_whenPhoneDoesNotExist() {
        when(customerRepository.findByPhoneIgnoreSpaces("000"))
